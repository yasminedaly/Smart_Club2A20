#ifndef MAINWINDOWYOSRA_H
#define MAINWINDOWYOSRA_H
#include <QMainWindow>
#include <QtSql>
#include <QSqlQuery>
...
namespace Ui {
class MainWindowyosra;
}

class MainWindowyosra : public QMainWindow
{
    Q_OBJECT

public:
    explicit MainWindowyosra(QWidget *parent = nullptr);
    ~MainWindowyosra();
