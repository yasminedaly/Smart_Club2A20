...
query.prepare ( " UPDATE  Evenement SET id=:id, nom =:nom,adresse=:adresse,num=:num,nb =:nb, date_event=:date  WHERE id =: id " );

     //query.prepare ( " UPDATE  Evenement SET id=:id, nom =:nom,num=:num,nb =:nb, date_event=:date  WHERE id =: id " );
