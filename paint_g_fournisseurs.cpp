...
Paint_G_fournisseurs::Paint_G_fournisseurs()
{
...
void Paint_G_fournisseurs::closeEvent(QCloseEvent *event)
{
...
void Paint_G_fournisseurs::open()
{
...
void Paint_G_fournisseurs::save()
{
...
void Paint_G_fournisseurs::penColor()
{
...
void Paint_G_fournisseurs::penWidth()
{
    // Stores button value
    bool ok;
...
void Paint_G_fournisseurs::about()
{
...
void Paint_G_fournisseurs::createActions()
{
...
// Create the menubar
void Paint_G_fournisseurs::createMenus()
{
...
bool Paint_G_fournisseurs::maybeSave()
{
...
bool Paint_G_fournisseurs::saveFile(const QByteArray &fileFormat)
{
