...
//
MainWindowyosra::MainWindowyosra(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::MainWindowyosra)
{
    ui->setupUi(this);
    ...
    /* //jeu2
     ...
     connect(ui->PDF, &QPushButton::clicked, this, &MainWindowyosra::on_PDF_clicked);
    ...
    /* QMediaPlayer *music=new QMediaPlayer();
     ...
     animation->setDuration(10000);
               animation->setLoopCount(-1);
               animation->setStartValue(QRect(0, 385, 191,20));
               animation->setEndValue(QRect(690, 385, 191, 20));
               animation->start();
...
MainWindowyosra::~MainWindowyosra()
{
    delete ui;
}
...
void MainWindowyosra::on_ajouter_2_clicked()
{
...
//
     /*ui->label->setText("Cet ID est déjà utilisé ");
...
void MainWindowyosra::on_supp_event_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
    int id=ui->le_id->text().toInt();
...
void MainWindowyosra::on_ajouter_3_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
    int id=ui->le_id->text().toInt();
...
//RECHERCHE EVENT
void MainWindowyosra::on_rechercher_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
    //click->play();
...
//TRIE EVENT
void MainWindowyosra::on_trie_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
    ui->tableView->setModel( Etmp.afficher_trie());
}

// PDF
void MainWindowyosra::on_PDF_clicked()
{
...
void MainWindowyosra::print(QPrinter *printer)
{
    QPainter painter;
...
void MainWindowyosra::on_ajouter_clicked()
{
QSound::play(":/new/prefix1/sond/Click button.wav");
   ...
   /* //
         ui->label_9->setText("Cet ID est déjà utilisé ");
                             ui->label_9->setVisible(!ui->label_9->isVisible());
                             QTimer::singleShot(500,this,SLOT(display_telephone_fournisseur()));

        }
    //
    void MainWindow::label_9()
    {
        ui->label_9->setVisible(!ui->label_9->isVisible());
        QTimer::singleShot(500,this,SLOT(display()));
    }*/
...
void MainWindowyosra::on_supp_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
...
// RECHERCHE TICKET
void MainWindowyosra::on_recherche_Ticket_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
            QString text;
...
void MainWindowyosra::on_Modifier_Ticket_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
    int id_ticket=ui->le_id_2->text().toInt();
    int id_evenement=ui->le_id_4->currentText().toInt();
     QString type_acheteur=ui->le_type_1->currentText();
...
void MainWindowyosra::on_le_id_textChanged(const QString &arg1)
{
    Evenement e;
...
void MainWindowyosra::on_le_id_2_textChanged(const QString &arg1)
{
    Ticket T;
...
void MainWindowyosra::on_tabevenement_currentChanged(int index)
{QSound::play(":/new/prefix1/sond/Click button.wav");
    ui->le_id_4->clear();
    ui->le_id_4->addItems(Etmp.listeEvents());
...
void MainWindowyosra::on_trie_2_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
     ui->tableView_2->setModel(Etmpp.afficher_trie());
}

void MainWindowyosra::sendMail()
{QSound::play(":/new/prefix1/sond/Click button.wav");
...
void MainWindowyosra::mailSent(QString status)
{
    if(status == "Message sent")
        QMessageBox::warning( 0, tr( "Qt Simple SMTP client" ), tr( "Message sent!\n\n" ) );
}

void MainWindowyosra::statrefresh(){
    // STATISTIQUE
...
void MainWindowyosra::on_envoyer_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
    sendMail();
}

void MainWindowyosra::on_tableView_activated(const QModelIndex &index)
{
...
void MainWindowyosra::on_tableView_2_activated(const QModelIndex &index)
{
    Ticket T;
...
void MainWindowyosra::on_clock_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
    AnalogClock * d = new AnalogClock();
         d->show();
}

void MainWindowyosra::on_Calculatrice_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
...
void MainWindowyosra::on_Radio_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
    Widget * q = new  Widget ();
    q->show();
}

void MainWindowyosra::on_notepad_clicked()
{ QSound::play(":/new/prefix1/sond/Click button.wav");
    note * n = new  note ();
    n->show();
...
void MainWindowyosra::on_test1_clicked()
{QSound::play(":/new/prefix1/sond/632.wav");
    Sudoku_Solver * su = new Sudoku_Solver ();
    su->show();
}

void MainWindowyosra::on_test1_2_clicked()
{ QSound::play(":/new/prefix1/sond/632.wav");
    multiplication * mu = new multiplication();
    mu->show();
}

void MainWindowyosra::on_play_music_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
    player * p = new player();
    p->show();
}

void MainWindowyosra::on_test1_3_clicked()
{QSound::play(":/new/prefix1/sond/Click button.wav");
    glowne * d = new glowne();
    d->show();
}
...
void MainWindowyosra::on_Jeu_echec_clicked()
{
